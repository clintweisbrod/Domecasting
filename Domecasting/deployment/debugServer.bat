...
"%JavaPath%\bin\java.exe" -classpath "domecasting.jar;.;commons-io-2.5.jar;log4j-api-2.9.1.jar;log4j-core-2.9.1.jar" com.spitzinc.domecasting.server.ServerApplication
